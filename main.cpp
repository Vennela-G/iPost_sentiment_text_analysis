...
int main() {
	...
	do {
		acct_type = UserInterface::printing_choice_options("What type of user are you?", "User", "Admin");

		if (acct_type == 1) {

			User current_user;

			entry_funct = UserInterface::printing_choice_options("What would you like to do?", "Login", "Register");
			...
			do {
				...
				acct_funct = UserInterface::printing_choice_options("What would you like to do?", "View Posts", "Make Post", "Delete Post", "Logout");
		...
		if (acct_type == 2) {
			...
			do {
				...
				if (acct_funct == 3) {
					acct_management_funct = UserInterface::printing_choice_options("What would you like to view", "Disable Account", "Enable Account");
